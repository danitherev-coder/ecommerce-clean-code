import { AddAddresDTO, AddressEntity, AuthEntity, CartEntity, UpdateUserDto, UserEntity, UpdateAddresDTO } from "../../index";
...
export abstract class UserDataSource {
    ...
    // agregar, actualizar y eliminar address al usuario
